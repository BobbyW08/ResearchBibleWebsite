  ...
  return (
    <div className="rounded-lg p-4" style={{ background: 'var(--card)', border: '1px solid var(--border)' }}>
      <div className="mb-3">
        ...
        <div className="text-xs" style={{ color: 'var(--muted-foreground)' }}>{side.subtitle}</div>
      </div>

      <div className="rounded-md px-3 py-2 mb-3 text-base font-semibold" style={{ background: '#5B8DB818', color: '#5B8DB8' }}>
        {side.provides}
      </div>

      <p className="text-base leading-relaxed mb-3" style={{ color: 'var(--foreground)' }}>
        {side.rightFor}
      </p>
      ...
      <div className="text-base leading-relaxed mb-3" style={{ color: 'var(--muted-foreground)' }}>
        <span className="font-semibold">Does not provide: </span>
        {side.doesNotProvide}
      </div>

      <div className="rounded-md px-3 py-2 text-base leading-relaxed" style={{ background: 'var(--background)', border: '1px solid var(--border)', color: 'var(--foreground)' }}>
