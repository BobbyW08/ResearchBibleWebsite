    ...
    <div className="my-6 grid grid-cols-1 md:grid-cols-2 gap-3">
      {cards.map((card, i) => {
        ...
        return (
          ...
          >
            <p className="text-base leading-relaxed font-semibold" style={{ color: 'var(--foreground)' }}>
            ...
            >
              <div className="text-xs uppercase tracking-widest mb-1.5" style={{ color: '#5B8DB8' }}>
                The reality:
              </div>
