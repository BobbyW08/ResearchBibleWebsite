...
// until now: block AI/bulk-scraping crawlers from /docs/ and /help/ (the
// long-form parent-facing content), while leaving Googlebot with full access
// for indexing. /research/ is intentionally NOT disallowed here — the
